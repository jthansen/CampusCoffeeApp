...
public class ClemensPerkNonEspressoDrinks extends ActionBarActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_clemens_perk_non_espresso_drinks);
	}
	...
	public void streamerPage(View view){
		//create next activity
		Intent intent = new Intent(this, ClemensPerkBasicWithDescription.class);
		//prices for 12oz and 16oz and the title
		String price12 = "$1.75  ";
		String price16 = "$2.25  ";
