...
public class ClemensPerkMenu extends ActionBarActivity {
	...
	public void espressoDrinksPage(View view){
		//create new activity
		Intent intent = new Intent(this, EspressoDrinks.class);
		//start next activity
		startActivity(intent);
	}
	...
	public void specialtyDrinksPage(View view){
		//create new activity
		Intent intent = new Intent(this, SpecialtyDrinks.class);
		//start next activity
		startActivity(intent);
	}	
	...
	public void smoothiesPage(View view){
		//create new activity
		Intent intent = new Intent(this, Smoothies.class);
		//start next activity
		startActivity(intent);
	}
	...
	public void nonespressoDrinksPage(View view){
		//create new activity
		Intent intent = new Intent(this, NonEspressoDrinks.class);
		//start next activity
		startActivity(intent);
	}
	...
	public void chillerzPage(View view){
		//create new activity
		Intent intent = new Intent(this, Chillerz.class);
		//start next activity
		startActivity(intent);
	}
